...
class DbConnector:
    ...
    DATABASE = "db" // Database name, if you just want to connect to MySQL server, leave it empty
    USERNAME = "user" // This is the user you created and added privileges for
